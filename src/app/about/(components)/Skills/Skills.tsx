...
const Skill: React.FunctionComponent<{
  name: string;
  x: string;
  y: string;
}> = ({ name, x, y }) => {
...
export const Skills = () => {
  return (
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight cursor-pointer dark:bg-circularDark lg:h-[80vh] sm:h-[60vh] xs:h-[50vh] lg:bg-circularLightLg lg:dark:bg-circularDarkLg md:bg-circularLightMd md:dark:bg-circularDarkMd sm:bg-circularLightSm sm:dark:bg-circularDarkSm">
        <motion.div
        ...
        <Skill name="Svelte" x="15vw" y="-12vw" />
